...
class LoginResponseModelMapper extends ClassMapperBase<LoginResponseModel> {
  ...
  static const Field<LoginResponseModel, String> _f$image =
      Field('image', _$image);
  static const Field<LoginResponseModel, dynamic> _f$accessToken =
      Field('accessToken', null, mode: FieldMode.param);
...
class LoginRequestModelMapper extends ClassMapperBase<LoginRequestModel> {
  ...
  static const Field<LoginRequestModel, dynamic> _f$username =
      Field('username', null, mode: FieldMode.param);
  static const Field<LoginRequestModel, dynamic> _f$password =
      Field('password', null, mode: FieldMode.param);
...
abstract class LoginRequestModelCopyWith<$R, $In extends LoginRequestModel,
  ...
  $R call({dynamic username, dynamic password});
...
class _LoginRequestModelCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({dynamic username, dynamic password}) =>
      $apply(FieldCopyWithData({#username: username, #password: password}));
  @override
